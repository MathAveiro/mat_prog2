...
public class exercicio37
{
   ...
   {
      House37 h = new House37("apartment",7,4);
      ...
      h.addRoom(new Room37(p1,p8, "hall"));
      h.addRoom(new Room37(p3,p2, "sala"));
      h.addRoom(new Room37(p4,p6, "corredor"));
      h.addRoom(new Room37(p5,p7, "quarto"));
      h.addRoom(new Room37(p9,p10, "quarto"));
      h.addRoom(new Room37(p11,p12, "wc"));
      h.addRoom(new Room37(p2,p13, "cozinha"));
      h.addRoom(new Room37(p10,p14, "copa"));
